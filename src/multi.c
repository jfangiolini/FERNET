 ...
 ***********************************************************************************/
int multiRoutine(config_t cfg, const char *filename)
{
    ...
    double centerx[mParms.nPSFX], centery[mParms.nPSFY],
	center[countPSF][2];
